...
2. Run `node scripts/manual/verify-live-fixture.mjs`. Expected WAV SHA-256: `434e16108b89c86d840235cf9ce52ffdc6945f12b33439e2bc2085bd15538a35`. The fixture is mono PCM16 at 16 kHz, 54.16 seconds. For TASK-102's smoke, use `--smoke-pcm-output=ABSOLUTE_PATH`: this creates a **30-second paused transport fixture**, repeating the first 8.5 seconds at 0 and 15 seconds and filling the remaining time with silence. Expected smoke hash: `0dd2604c156933444bf362c59d82d84096d58ea28ab6d13e244f46a65df4869f`. It is not the old continuous first-30-second crop. The smoke rejects input without two speech sections followed by at least three seconds of PCM silence, including the end. See [offline correction evidence](../SCRIBE-OFFLINE-2026-09-17/README.md). For the full browser fixture, `--pcm-output=ABSOLUTE_PATH` still exports all 54.16 seconds; expected PCM hash: `c51b1eba24fcdc97e5212b436dbb70f83525e57716bcf4a7e2257eec3d20140e`. Both options refuse overwriting. Do not give the longer file to the 30-second smoke harness.
