...
**Current package:** `release/c97792142b8b/`, pairing LiveLecture `c97792142b8b3bf2401faa623b9feeb8cd59bf31` with the remote-free copy `d03f99b14895c392355bcfa3c0c2985ad7073d31`. It includes the independently reviewed [question-field and confirmation-button contrast corrections](../ACCEPTANCE-2026-09-18/CONTRAST.md). Primary 702 checks and CI `35348515987`, copy 387 tests/guarded build, sampled rendered contrast and package hashes pass. All ten extension files match the final audit. Use this pair for the current human handoff; prior packages and provider evidence below remain preserved historical checkpoints. Native/human/provider-retention/judge acceptance is still pending.

**Fresh-source rehearsal, September 19:** this exact pair also passed new source-archive installs, full primary/copy checks, rebuilt-extension byte parity and the paired production HTTP journey. [Fresh candidate evidence](../ACCEPTANCE-2026-09-19/README.md) records the separate fixture commits, complete logs and cleanup. This closes the current package's fresh-source setup check, not Chrome or human acceptance.
