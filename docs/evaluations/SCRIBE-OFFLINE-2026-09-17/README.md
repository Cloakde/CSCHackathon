...
**State:** implemented; focused offline checks pass. Independent review and full repository checks pending. No provider call, browser control, ledger change or live acceptance occurred.
