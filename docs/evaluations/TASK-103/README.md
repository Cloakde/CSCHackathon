...
| Missing inner derivative    | 001–006, 300-second lookback, 300 seconds          | 004/006: multiply outside and inside derivatives. Missing factor `2`; derivative `8(2x+3)³`. Include 005 when reconstructing the full lecture example `(3x²+1)⁵`.                   |
