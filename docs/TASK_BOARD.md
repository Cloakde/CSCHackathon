...
| TASK-301 Private MeltingPot lecture review   |    1 | IN PROGRESS | m3_meltingpot     | Product Owner Execute; independently approved ADR 0008 and task contract                  | `docs/tasks/TASK-301.md`; isolated `task/TASK-301-private-lecture-review` in MeltingPot copy                                                               |
| TASK-302 Extension-to-MeltingPot handoff     |    1 | IN REVIEW   | m3_extension      | Reviewed contract; independent source approval `e9954ca6e67411a0b99b09261fed3f4724199ab3` | Five owned extension files; candidate cherry-picked to integration as `3f3bd4e`                                                                            |
| TASK-303 Connected journey acceptance        |    1 | IN PROGRESS | Codex Coordinator | TASK-301/302 engineering; final exact review/checks required; human acceptance pending    | `docs/tasks/TASK-301.md`; paired component/production HTTP checks, runtime isolation, vendor/dependencies, safe launchers and coordination                 |
...
- **M3:** **MeltingPot connection and resilience**, synthetic engineering in progress under TASK-301–303. The Product Owner authorized execution and `m3_review` approved the handoff/access contract at `5427e097ec73234e886f63049189cf136fcc7378`. Pending M2 and repeated M3 human/AI/judge evidence remains a tracked obligation; it is not waived.
...
Current concrete work: finish TASK-301–303's bounded synthetic connection and independent integration checks. The paired component journey already exercises the actual extension component, LiveLecture dispatcher, MeltingPot relay, and private review for two distinct concepts; production HTTP, exact review, and CI remain required before integration. Keep the existing M2 service available. Arrange the pending human checks only with session-specific browser permission and repeat acceptance on the new destination. Actual AI work needs its own TASK-103 contract and capped provider authorization. Live audio remains conditional and M4 breadth stays deferred.
...
| Available engineering lanes              | **TASK-201–204 merged; TASK-301 assigned to m3_meltingpot, TASK-302 to m3_extension, TASK-303 to Coordinator; m3_review reviews independently; independent promotion required** |
