...
| TASK-003 Align MeltingPot milestones         |    1 | IN REVIEW | Codex Coordinator | Product Owner Execute on the proposed milestone revision                                                     | `docs/tasks/TASK-003.md`; branch `coord/TASK-003-meltingpot-milestones`; base `a7dc31e6aef64143486b170247b9d6dc5da930ba`              |
...
| TASK-301 Private MeltingPot lecture review   |    1 | TODO      | unassigned        | Reviewed handoff/access contract, exact bases in both repos, exclusive paths, and applicable execution gates | Contract not yet written; no implementation paths reserved                                                                            |
| TASK-302 Extension-to-MeltingPot handoff     |    1 | TODO      | unassigned        | TASK-301 and reviewed shared handoff/access contract; task assignment                                        | Contract not yet written; no implementation paths reserved                                                                            |
| TASK-303 Connected journey acceptance        |    1 | TODO      | unassigned        | TASK-302; exact app revisions, independent reviewer and human window                                         | Two-concept practice/citation journey, privacy and recovery evidence; no implementation paths reserved                                |
...
- **M3:** next build milestone, **MeltingPot connection and resilience**. TASK-301–303 describe the staged work; their contracts, assignments, and applicable gates must be completed before implementation. Pending M2 evidence remains a tracked obligation while bounded synthetic preparation proceeds; it is not waived.
...
Next concrete build task: TASK-301, a private lecture-review area in the separate MeltingPot copy using synthetic lectures. First define and independently review the handoff/access contract and assign exclusive paths; TASK-302 then connects the extension's Finish action. TASK-303 checks the complete private practice/citation journey with two distinct concepts and visible recovery states. Keep the existing M2 demo available, arrange its pending human checks with session-specific browser permission, and repeat acceptance on the new destination. In parallel, prepare a separately assigned TASK-103 provider/evaluation contract; do not call a provider without capped authorization. Live audio remains conditional and M4 breadth stays deferred.
...
| Available engineering lanes              | **TASK-201–204 merged; TASK-003 planning/review active; TASK-301–303 and optional live tasks remain unassigned**                                       |
