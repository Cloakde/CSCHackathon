...
**Latest assignment, TASK-309 (2026-09-15):** the user explicitly requested autonomous continuation of MeltingPot. Codex owns the private copy's lecture study continuity, source flashcards/review queue and explicit portable study files, plus tests and coordination. See [TASK-309](docs/tasks/TASK-309.md) and current handoff. This scoped amendment supersedes prior feature holds; original services, API/desktop use and release acceptance remain excluded.

**Latest assignment, 2026-09-15:** the user said “Execute them all” on the remaining-milestone roadmap. [TASK-308](docs/tasks/TASK-308.md) supersedes the older correction-only, copy-read-only and implementation holds below. Codex owns the bounded live bridge, Gemini-aware isolated MeltingPot review, source notes/bookmarks, verification and release preparation. One AI works at a time. The current handoff and [TASK-308 evidence](docs/evaluations/TASK-308/README.md) control readiness; old “TASK-307 unstarted” statements are historical. Real-service/human tests, source approval and submission remain distinct gates. Original MeltingPot repositories/services remain excluded.

**Current correction (2026-09-07):** The user requested “Okay fix everything” after Codex's independent review of Claude's TASK-101/102 at `8336516`. Codex owns the bounded offline capture, transcription, token-route and manual-launcher correction, its tests and coordination/evidence updates. Read [the correction evidence](docs/evaluations/TASK-101-102/README.md) and latest handoff. A later user-started AI must independently review these changes. TASK-307 remains unstarted; TASK-306's review is separately outstanding. No API use, credentials, copy edits, desktop control, broader milestones or main merge are authorized.
...
**Current user direction (2026-09-06): no API testing yet.** The earlier [offline queue in TASK-304](docs/tasks/TASK-304.md) has been reviewed and corrected; current source and remaining work are in the handoff. Provider testing is deliberately deferred; do not ask for keys/spend or run free-tier/connectivity/token-count tests to continue. Broader M4 features and human/provider acceptance remain gated.
